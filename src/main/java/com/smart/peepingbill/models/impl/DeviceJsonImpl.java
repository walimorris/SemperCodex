...
import com.smart.peepingbill.models.DeviceJson;
 ...
 */
public class DeviceJsonImpl implements DeviceJson {
    private static final Logger LOG = LoggerFactory.getLogger(DeviceJsonImpl.class);
     ...
     */
    public DeviceJsonImpl(String deviceName, String ipaddress, String macAddress, String sudo, Boolean isHost) {
